...
import {FormControl,FormLabel,Image,InputGroup,Input,Text,Flex,Grid, GridItem,Heading, Spacer} from '@chakra-ui/react';
...
<br />
          ...
          <button style={{backgroundColor:"red", width:"150px", color:"white", padding:"5px", fontSize:"18px",  borderRadius:"10px", border:"none"}}>PAY</button>
